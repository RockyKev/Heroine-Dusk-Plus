...
export function tileset_init() {
  ...
  tileset.background_img[0].onload = function() {tileset_onload();};
    ...
    tileset.background_img[1].src = "images/backgrounds/exterior.png";
  ...
  // tileset.background_img[2].src = "images/backgrounds/tempest.png";
    tileset.background_img[2].src = "images/backgrounds/trees.png";
  tileset.background_img[2].onload = function() {tileset_onload();};

    tileset.background_img[3].src = "images/backgrounds/interior2.png";
...
// TODO: Tile names instead of numbers
